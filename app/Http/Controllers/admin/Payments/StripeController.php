...
class StripeController extends Controller
{
    ...
    public function orderPost(Request $request)
    {
        ...
        try {
            ...
            $stripe_key = Stripe::setApiKey(config()->get('services.stripe.secret'));
            // dd($stripe_key,config()->get('services.stripe.secret'));
    ...
    public function stripe_checkout($package_id = '')
    {
        ...
        $product_name = $package_detail->title;
            ...
            if (empty($api_error) && $checkout_session) {
                ...
                if (empty($api_error) && $paymentIntent) {
                    ...
                    if (!empty($paymentIntent) && $paymentIntent->status == 'succeeded') {
                        ...
                        return redirect()->route('dashboard', ['locale' => 'en']);
                    } else {
