                ...
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        ...
                        <form id='checkout-form' method='post' action="{{ route('stripe.post') }}">
                            ...
                            <input type='hidden' name='amount' value="{{$subCategory_detail->price}}" id='amount'>
                            <input type='hidden' name='order_date[]' value="{{ json_encode($orderData) }}" id='order_id'>
                            <br>
                            ...
                            <button
                                ...
                                onclick="createToken()">PAY ${{$subCategory_detail->price}}
                            </button>
                            <form>
