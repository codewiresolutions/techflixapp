...
@section('content') 
		...
		<main>
  <section class="section_main-blog">
    <section class="blog_img">
      <div class="main_bg_img">
        <img src="https://dummyimage.com/1300x600/000/dcdce0&text=Main_bg_img" alt="" class="img">
      </div>
...
.section_blog .input-group>.custom-select:not(:last-child), .input-group>.form-control:not(:last-child) {
  border-top-right-radius: 10px;
