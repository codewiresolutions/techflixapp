        ...
        <main class="msger-chat">
          <div class="msg left-msg">
            ...
            <div class="msg-bubble">
              <div class="msg-info">
                <div class="msg-info-name">lorem</div>
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="form_group_of_profile">
                     ...
                     <div class="input">
                        <input type="text" class="control_field form-control" id="fv-price" name="description"
                                value="{{ isset($order_deatil->description) ? $order_deatil->description : '' }}" readonly>
                     </div>
                  </div>
               </div>
{{--
    ...
    if (data.length > 0) {
      ...
      data.forEach(function(message) {
        if (message.id !== lastMessageId) {
          ...
          var msgInfoName = message.sender_type === 'staff' ? 'Staff' : 'User';
