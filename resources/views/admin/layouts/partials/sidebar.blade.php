...
<section class="sider_dashbord_login">
    ...
    <div class="side_nav" id="sidebar">
        ...
        <ul class="sidebar p-0">
            ...
            <div class="more_menu">
                <a href="{{ route('user.score') }}" class="menu_item">
                    <div class="menu_icon">
                        <img src="{{ asset('assets/images/users.svg')}}" alt=""
                             class="img"/>
                    </div>
                    <div class="menu_name">User Score</div>
                </a>
            </div>
            @if(Auth::check() && Auth::user()->user_type  == "superadmin")
                <li class="nav-items <?php if($page=='Product.php'){echo 'active';} ?>">
                    ...
                    <div class="more_menu">
                        <a href="{{ route('admin.jobs.index') }}" class="menu_item">
                            <div class="menu_icon">
                                <img src="{{ asset('assets/images/job-opportunities-svgrepo-com.svg')}}" alt=""
                                     class="img"/>
                            </div>
                            <div class="menu_name">Jobs</div>
                        </a>
                    </div>
                    <div class="more_menu">
                        <a href="{{ route('admin.job.applicants') }}" class="menu_item">
                            <div class="menu_icon">
                                <img src="{{ asset('assets/images/job-opportunities-svgrepo-com.svg')}}" alt=""
                                     class="img"/>
                            </div>
                            <div class="menu_name">Job applicants</div>
                        </a>
                    </div>

                    <div class="more_menu">
                        <a href="{{ route('admin.quizzes.index') }}" class="menu_item">
                            <div class="menu_icon">
                                <img src="{{ asset('assets/images/job-opportunities-svgrepo-com.svg')}}" alt=""
                                     class="img"/>
                            </div>
                            <div class="menu_name">Quizzes</div>
                        </a>
                    </div>
                    ...
                    {{--              <div class="more_menu">--}}
                    {{--                  <a href="{{ route('admin.quizzes.questions.index') }}" class="menu_item">--}}
                    {{--                      <div class="menu_icon">--}}
                    {{--                          <img src="{{ asset('assets/images/job-opportunities-svgrepo-com.svg')}}" alt="" class="img" />--}}
                    {{--                      </div>--}}
                    {{--                      <div class="menu_name">Questions</div>--}}
                    {{--                  </a>--}}
                    {{--              </div>--}}
